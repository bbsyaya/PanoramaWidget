...
@property (readwrite, nonatomic, assign) int lumaLine;
@property (readwrite, nonatomic, assign) int chromaBLine;
@property (readwrite, nonatomic, assign) int chromaRLine;
